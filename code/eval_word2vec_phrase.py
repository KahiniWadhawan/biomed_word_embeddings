...
model_bin_file_name = 'full-pubmed-text_lower-vectors-phrase-ng10-hs0-dim200-textwin30-subsample4-mincount5-alpha0.05.bin'
model_bin_file = os.path.join(MODEL_DIR, model_bin_file_name)
# When loading phrase model, you get the error
# UnicodeDecodeError: 'utf8' codec can't decode byte 0xd0 in position 57: unexpected end of data
# To fix the error, refer -
...
# Set the unicode_errors flag when running load_word2vec_model,
# e.g. load_word2vec_model(..., unicode_errors='ignore'). Note that this silences the error,
# but the utf8 problem is still there -- invalid utf8 characters will just be ignored in this case.
model = gensim.models.KeyedVectors.load_word2vec_format(model_bin_file, binary=True, unicode_errors='ignore')

PAIR_FILES_DIR          = "results/subset_original_files_with_mean"

OUPUT_COSINE_SIM_FILES_DIR = "results/scores/word2vec_phrase"
